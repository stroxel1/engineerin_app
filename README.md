...
- High-solids (>60 wt%) citric acid BPE now uses a Dühring-rule correlation calibrated to the 15-60 wt% table (slope vs concentration R² = 0.999996).  The Dühring method provides physically grounded pressure-scaling so evaporation and crystallizer screens work correctly under vacuum.  At 60 wt% the Dühring prediction matches the tabular value to within 0.007 °F.  Treat extrapolated values above 60 wt% as screening estimates.
